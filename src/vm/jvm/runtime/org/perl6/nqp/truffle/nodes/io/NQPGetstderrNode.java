...
@NodeInfo(shortName = "getstderr")
public final class NQPGetstderrNode extends NQPObjNode {
    HLL hll;
    GlobalContext globalContext;

    @Deserializer
    public NQPGetstderrNode(HLL hll, GlobalContext globalContext) {
        this.hll = hll;
    ...
    public Object execute(VirtualFrame frame) {
        ...
        handle.handle = new StandardWriteHandle(globalContext.err);
        return handle;
    }
}
