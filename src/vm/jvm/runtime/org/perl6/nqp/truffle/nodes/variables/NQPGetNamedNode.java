...
public class NQPGetNamedNode extends NQPObjNode {
    private final FrameSlot slot;
    private final String[] names;
    private final NQPNode defaultValueNode;

    public NQPGetNamedNode(FrameSlot slot, String[] names, NQPNode defaultValueNode) {
        this.slot = slot;
        this.names = names;
    ...
    public Object execute(VirtualFrame frame) {
        ...
        for (String name : names) {
            Object value = NQPArguments.getNamedArgument(args, name);
            if (value != null) {
        ...
        if (defaultValueNode != null) {
            Object defaultValue = defaultValueNode.execute(frame);
            frame.setObject(slot, defaultValue);
            return defaultValue;
        } else {
            // XXX this should be an error
            System.out.println("we don't have a default value");
            return null;
        }
    }
}
