...
public abstract class SyncHandle implements IIOClosable, IIOEncodable,
    ...
    public int exitValue() {
        try {
            if (chan instanceof ProcessChannel) {
                ...
                throw new RuntimeException("This channel does not support exitValue");
    ...
    public synchronized String readchars(int chars) {
        try {
            dec.reset();
    ...
    protected long write(ByteBuffer buffer) {
        try {
    ...
    public void setInputLineSeparator(String sep) {
        try {
