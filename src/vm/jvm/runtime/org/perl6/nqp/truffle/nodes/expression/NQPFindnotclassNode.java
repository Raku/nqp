...
@NodeInfo(shortName = "findnotclass")
public final class NQPFindnotclassNode extends NQPIntNode {
    ...
    @Deserializer
    public NQPFindnotclassNode(NQPNode aNode, NQPNode bNode, NQPNode cNode, NQPNode dNode) {
        this.aNode = aNode;
        this.bNode = bNode;
        this.cNode = cNode;
        this.dNode = dNode;
