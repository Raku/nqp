...
public class VMArrayInstance_s extends SixModelObject {
    ...
    public void at_pos_native(ThreadContext tc, long index) {
        ...
        tc.native_type = ThreadContext.NATIVE_STR;
        tc.native_s = slots[start + (int)index];
    }
    ...
    public void bind_pos_native(ThreadContext tc, long index) {
        ...
        tc.native_type = ThreadContext.NATIVE_STR;
        slots[start + (int)index] = tc.native_s;
    }
    ...
    public void push_native(ThreadContext tc) {
        ...
        tc.native_type = ThreadContext.NATIVE_STR;
        slots[start + elems - 1] = tc.native_s;
    }
