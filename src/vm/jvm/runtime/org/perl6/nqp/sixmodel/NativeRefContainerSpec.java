...
public class NativeRefContainerSpec extends ContainerSpec {
    ...
    public SixModelObject fetch(ThreadContext tc, SixModelObject cont) {
        final NativeRefREPRData rd = (NativeRefREPRData)cont.st.REPRData;
        final HLLConfig hll = (cont.st.hllOwner != null)
            ? cont.st.hllOwner
    ...
    /**
     * Stores a value in a container, without any checking of it
     * (this assumes an optimizer or something else already did it).
     * Used for assignment.
     */
