...
#define EDGE_CODEPOINT_M       16
#define EDGE_CODEPOINT_M_NEG   17
#define EDGE_CODEPOINT_M_LL    18
#define EDGE_CODEPOINT_IM      19
#define EDGE_CODEPOINT_IM_NEG  20
#define EDGE_CODEPOINT_IM_LL   21
