...
Building the JavaScript backend currently requires building the parrot backend.

perl Configure.pl --backends=parrot,js
make

To install the runtime into node_modules:
