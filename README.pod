...
The L<examples directory|examples> is a good place to start, with the
L<loops|examples/loops.nqp> and other files. Opcodes are listed in
L<the docs directory|docs/ops.markdown>. You can use NQP from this
