...
# environment. This is kinda faking up how roles work.
{
    ...
    # more invocations just to avoid getting lucky...
    $raw_sub('stress test 0');
    $raw_sub('stress test 1');
    $raw_sub('stress test 2');
    $raw_sub('stress test 3');
    $raw_sub('stress test 4');
    $raw_sub('stress test 5');
    $raw_sub('stress test 6');
    $raw_sub('stress test 7');
