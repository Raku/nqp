...
=head1 Direct use
    ...
    my $GlobalContext := nqp::jvmbootinterop('org.perl6.nqp.runtime.GlobalContext')</TYPE/>;
    my $Thread := nqp::jvmbootinterop('java.lang.Thread')</TYPE/>;

    $Thread.unbox(
        $GlobalContext.unbox($GlobalContext.box(nqp::null())).get_bootInterop.implementClass(
